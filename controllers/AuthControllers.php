...
{
  /**
   * Función que redirige a la vista del login
   */
  ...
  public function home()
  {
    if (isset($_SESSION['identity'])) {
      echo $GLOBALS['twig']->render('home.twig', [
        'identity' => $_SESSION['identity'], 'URL' => URL
      ]);
    } else {
  ...
  /**
   * Función que cierra la sesión siempre y cuando encuentre un $_SESSION['identity']
   */
